...
const MOCK_QUESTIONS = [
  ...
  },
  {
    ...
    answer: 'A controlled component has its value managed by React state, while an uncontrolled component manages its own state internally (like a form input). Controlled components are predictable but require more code, whereas uncontrolled components are simpler but less flexible.'
  },
  {
    id: 4,
    question: 'How would you optimize the performance of a large React list?',
    answer: 'You can optimize large lists by using key props correctly, implementing React.memo for list items, using virtualization libraries like react-window, lazy loading items, and avoiding inline functions/objects that cause unnecessary re-renders.'
  },
  {
    id: 5,
    question: 'What is the purpose of useCallback hook?',
    answer: 'useCallback memoizes a function and returns a cached version of it. This is useful when passing callbacks to optimized child components that rely on reference equality. It helps prevent unnecessary re-renders by ensuring the function reference doesn\'t change on every render.'
  }
];
        ...
        {MOCK_QUESTIONS.map((item, idx) => (
          ...
          >
            ...
            >
              ...
              <div className="flex-shrink-0 ml-1 text-gray-400 group-hover:text-gray-600">
                {expandedId === item.id ? (
